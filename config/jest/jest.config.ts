...
const config: Config = {
  ...
  // instances, contexts and results before every test
  'clearMocks': true,
  ...
  // cacheDirectory:
  // "/private/var/folders/87/5pgr_tm172z9v9pwk_hjy6mw0000gn/T/jest_dx",
  ...
  // An object that configures minimum threshold
  ...
  // using an array of glob patterns
  // forceCoverageMatch: [],
  ...
  // A set of global variables that need to be
  // available in all test environments
  // globals: {},

  // The maximum amount of workers used to run
  // your tests. Can be specified as % or a number. E.g. maxWorkers: 10% will
